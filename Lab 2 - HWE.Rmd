...
<br>
In population genetics studies, you will often see Hardy-Weinberg Equilibrium being used to measure whether the observed genotype frequencies of a specific SNP or microsatellite are the same as the estimated genotype frequencies. This is often accompanied by a Chi Square Goodness Of Fit test, the output of which is a P-value that will tell you how much the observed genotype frequency deviates from the expected frequency. We saw this application of Hardy-Weinberg Equilibrium in the paper (insert paper title here), which looked at the Hardy-Weinberg Equilibrium for the SNP (insert SNP ID here).  
