...
HWEYRI #Running the name of your results file will print the results
```
...
* When you have found your SNP in the table, click on the SNP ID to get to the SNP page. From there, click on the "Population Genetics" tab to get the population genetics table. 
...
* Find your population in the table. Record the genotype frequency count numbers (heterozygous, homozygous 1 and homozygous 2). These will be your input to the UI below. Using this method, find these genotype frequencies for each SNP you want to test for Type 1 Error. 
