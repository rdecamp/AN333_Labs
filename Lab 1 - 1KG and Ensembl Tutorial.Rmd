...
#### Step 4: Using the Data Slicer to Get VCF Data
...
* Hit the "Download results file" button. You will get a zipped file with your data, which we will work with in the next lab. Make sure you save it to a place where you remember where it is.

* Rename this file with the acronym for your population. For example, a good name would be "YRI.vcf.gz"

The last thing we'll do is to put our newly downloaded files in to the folders we made int he SCC tutorial. To do that: 
<br>
 
* Open a new Moba X Term window on the computer. 
