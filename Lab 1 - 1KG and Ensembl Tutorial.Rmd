...
* Hit the "Download results file" button. You will get a file with your data. Rename this file with the acronym for your population. For example, I downloaded data from the YRI population, so I named this file "YRI.vcf." Save the file to the desktop. 
<br> 
<br> 
...
* Now you are in the directory you will use for this class. Go to the desktop of the computer, and your downloaded file should be right on the home screen. Simply drag the file from the desktop and drop it in to your directory's interface like so:
<br>
<br>
...
After you drag and drop your file, you'll see it in your directory: 
<br>
<br>
